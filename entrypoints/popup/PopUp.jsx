...
function PopUp() {
  ...
  const fallbackMessage =
    tabs.length === 0 ? getEmptyPopUpFallBackMessage() : "";

  return (
    <div className="w-[420px] max-h-[500px] overflow-y-auto p-3 pr-0 flex flex-col gap-2 text-base bg-[#222222] text-white">
      <header className="px-3 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          {tabs.length > 1 && (
            <>
              ...
              />
              <label className="cursor-pointer" htmlFor="select_all">
                Select all
              </label>
            </>
          )}
        ...
        <div className="flex gap-2">
          <button
            className="py-1 px-3 flex gap-1 items-center rounded-full cursor-pointer bg-[#2a2e3b] hover:bg-[#364155] text-blue-200"
